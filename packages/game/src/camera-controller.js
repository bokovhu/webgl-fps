import { Camera, renderContext, UNIFORM } from "@me.bokov.webglfps/rendering";
import { CHUNKSIZE, CAMERASPEED, MOUSESENSITIVITY } from "./constants";
import { vec3 } from "gl-matrix";
import { updateRenderContext } from "../../rendering/src";
...
export class CameraController {
    ...
    init(platform) {
        ...
        this.camera = new Camera({
            ...
            applyToRenderContext: (opts) => {
                renderContext.transform.view = opts.view;
                renderContext.transform.projection = opts.projection;
                renderContext.camera = opts.camera;
